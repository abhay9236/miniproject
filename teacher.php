 ...
 <body>
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number ">
              <input class="form-control" name="end" placeholder="Ending Roll Number">
  ...
  <div class="modal fade delete-warning" tabindex="-1" role="dialog" aria-labelledby="delete-warning" aria-hidden="true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <h2 class="text-center"> Do you want to delete <br> <span class="warning-class"></span> ?</h2>
        <hr>
